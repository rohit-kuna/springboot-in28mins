package com.rohitkuna.dependencyinjection.v1;
...
public class DepInjApplication {
    public static void main(String[] args) {
        try(var context = new AnnotationConfigApplicationContext(DepInjApplication.class)) {
            ...
            System.out.println(context.getBean(Business.class)); // null i.e. instances are created but not injected or wired into Business class
        }
    }
}
